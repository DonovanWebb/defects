...
Why?
Swarming behaviour
Towards mobile autonomous agents.
Group 'decisions' without any centralized control.
Seen in nature with bees, ants, flocks of birds, schools of fish, herds.
Now we have an mesoscale artificial controllable example with skyrmions in LC.

Slide 2:
Simulating Active matter with skyrmions.
rod like molecules.
Chiral Helical LC in frustrated geometry due to boundary conditions of plate.
Spontaneuous or created defects can be made --- these are stable! --- skyrmions/baby skyrmions/torons/topological solitons.
Deeper dive into structure of a skyrmion.
Spin texture.

Slide 3:
squirming motion of the skyrmion
Apply modulating electric field perpendicular to LC
There is assymmetric response to voltage on vs voltage off.
Explained by the different balances of torque:
    ON:  electric torque balanced by elastic and viscous torque.
    OFF: elastic and viscous torque.
This leads to a net translation of the skyrmion.
!!Need to work out direction!!
Two particle interactions may be observed as elastic deformations are shared to lower overall energy
Attraction/repulsion/collective motion

Slide 4:
Collective motion
The many body instance has more complex behaviour due to longer range elastic interactions 

Slide 5:
Different regimes of collective motion with different clustering 
Phase diagram

Slide 6:
Uses
Cargo transport
Dynamic responses to stimuli
Unexplored frontiers however judging from nature - swarm dynamics can accomplish extremely complex tasks in a distributed manner.
